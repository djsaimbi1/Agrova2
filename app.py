...
section[data-testid="stSidebar"] .stSelectbox [data-baseweb="select"]>div>div>div {
  background:#0d2e28 !important;
  border-color:#1a4a3f !important;
}
...
@media (max-width: 768px) {
  ...
  /* Hero */
  .av-hero{max-width:100% !important; border-radius:14px !important; padding:2rem 1.2rem !important;}
...
@media (max-width: 480px) {
  ...
  /* Hero */
  .av-hero{border-radius:12px !important;}
...
# ══════════════════════════════════════════════════════════════
    ...
    dp[1].metric("💰 Sell price/kg", f"₹{round(price_kg*0.9)}–₹{round(price_kg*1.1)}")
